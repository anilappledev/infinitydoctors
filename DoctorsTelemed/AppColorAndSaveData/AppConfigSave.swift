...
class AppColor: NSObject {
    ...
    static let AppBlueRGB : UIColor = UIColor( red: CGFloat(57/255.0), green: CGFloat(85/255.0), blue: CGFloat(150/255.0), alpha: CGFloat(1.0) )
   ...
   // rgb(176,173,254)
    ...
    static let AppPinkRGB : UIColor = UIColor( red: CGFloat(235/255.0), green: CGFloat(89/255.0), blue: CGFloat(102/255.0), alpha: CGFloat(1.0) )
